...
<head>
    ...
    <title>فشل الدفع — {{ config('app.name') }}</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .icon-wrap { width: 80px; height: 80px; border-radius: 50%; background: #fee2e2; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem; }
        .icon-wrap svg { width: 40px; height: 40px; color: #b91c1c; }
        h2 { font-size: 1.5rem; font-weight: 800; color: #b91c1c; margin-bottom: .5rem; }
        p.sub { color: #64748b; font-size: .95rem; margin-bottom: 1.5rem; }
        .error-box { background: #fff5f5; border: 1px solid #fecaca; border-radius: 12px; padding: 1rem 1.25rem; margin-bottom: 1.75rem; font-size: .9rem; color: #b91c1c; text-align: right; }
...
<div class="card">
    ...
    <h2>فشل الدفع</h2>
    <p class="sub">لم تتم عملية الدفع — يمكنك المحاولة مرة أخرى.</p>
    ...
    <div class="actions">
        <a href="{{ route('portal.invoices.show', $invoice->id) }}" class="btn btn-primary">حاول مجدداً</a>
