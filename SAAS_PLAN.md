...
1. **اسم المنصة الأم: «ميزان»** — هي الشركة/المنصة التي تشترك فيها المكاتب والمحامون. كل مكتب (مثل «مكتب ميزان للمحاماة») مجرد عميل مشترك داخل ميزان.
...
- **`/offices/{slug}`** = هوية المكتب نفسه (ميزان، إلخ) — اسمه وشعاره وبياناته من `settings`.
...
| `GET /offices/mizan` | صفحة مكتب ميزان التعريفية |
